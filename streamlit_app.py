...
def main():
    ...
    # -----------------Sección donde se visualizan las ventas totales-----------------#
        ...
        components.html("""
        <iframe src="https://solid-space-cod-6jxrvw5rg45crrpp-8051.app.github.dev" width="100%" height="100%" frameborder="0" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0;"></iframe>""", 
        height=800)
